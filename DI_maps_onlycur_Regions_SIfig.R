...
for(region in regs){
    ...
    dir_figs <- dir_(paste0('Dams_impact/figs/',region,'/',damsdata1,'/',mva_type,'/'))
    ...
    #processed data
    dir_proc_out <- paste0('Dams_impact/proc/',region,'/',damsdata1,'/model_DI_occurrence/',mva_type,'/') # specific for relation
    ###
    #directories
    ...
    # second plot with small dams added
    
    
    #figure only large dams
    dir_(paste0('Dams_impact/figs/',region,'/'))
    dir_(paste0('Dams_impact/figs/',region,'/',damsdata2))
    dir_figs <- dir_(paste0('Dams_impact/figs/',region,'/',damsdata2,'/',mva_type,'/'))
    dir_(paste0(dir_figs,"paper/"))
    dir_(paste0(dir_figs,"paper/extra/"))
    dir_(paste0(dir_figs,"paper/maps/"))
    dir_(paste0(dir_figs,"paper/maps/extra/"))
    ...
    #processed data
    dir_proc_out <- paste0('Dams_impact/proc/',region,'/',damsdata2,'/model_DI_occurrence/',mva_type,'/') # specific for relation
    ###
    #directories
    dir_out_tabs <- (paste0(dir_proc_out,"tabs/"))
    ...
    dev.off()
    ggsave(paste0(dir_figs,'paper/maps/NEW_SB_PAF_bothfigs.jpg'),figure2, height = 150, width = 178,
           dpi = 1000,units = 'mm')
    }
    ...
    if(region=="BRA"){
      ...
      dev.off()
      ggsave(paste0(dir_figs,'paper/maps/NEW_SB_PAF_bothfigs.jpg'),figure2, height = 120, width = 178,
             dpi = 1000,units = 'mm')
    }
    ...
    if(region=="USA"){
      ...
      dev.off()
      ggsave(paste0(dir_figs,'paper/maps/NEW_SB_PAF_bothfigs.jpg'),figure2, height = 200, width = 178,
             dpi = 1000,units = 'mm')
    }
