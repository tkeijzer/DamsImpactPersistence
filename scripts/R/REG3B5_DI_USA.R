...
# combine scripts DI_interbasins, DI_interb_speciesrange, (prep_)DI_create_SR_PLR_tabs
# Tamara Keijzer
# April 2023
...
dir_out <- dir_(paste0(dir_proc,"USA/", damsdata,"/model_DI_occurrence/",mvrs_type,"/"))
dir_out_tabs <- dir_(paste0(dir_proc,"USA/", damsdata,"/model_DI_occurrence/",mvrs_type,"/tabs/"))
...
#>> Dams data
cat('Load dams data..\n')
dams_USA <- readRDS(paste0('Dams_impact/proc/dams_USA_hydrobasins_',damsdata,'.rds'))
dams_cur=dams_USA
