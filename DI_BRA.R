...
dir_out <- dir_(paste0(dir_proc,"BRA/", damsdata,"/model_DI_occurrence/",mva_type,"/"))
dir_out_tabs <- dir_(paste0(dir_proc,"BRA/", damsdata,"/model_DI_occurrence/",mva_type,"/tabs/"))
